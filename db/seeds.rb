...
m7 = Move.create(name: 'Flirt', summary: "lowering the opponent's defense", description: "Lowers opponent's defense", category: 'stat-based', target: 'other', stat: 'defense', value: -33, cost: 7)
